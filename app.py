...
app = Flask(__name__)
app.secret_key = 'shanto-secret-key'
...
def load_users():
    if not os.path.exists(USERS_FILE):
        default = {"admin": {"password": "SHANTO123", "role": "ADMIN"}}
        save_users(default)
        return default
    with open(USERS_FILE, 'r', encoding='utf-8') as f:
        data = json.load(f)
    if 'admin' not in data:
        data['admin'] = {"password": "SHANTO123", "role": "ADMIN"}
        save_users(data)
    return data
...
def create_default_files(server_dir):
    ...
    if not os.path.exists(main_py):
        with open(main_py, 'w', encoding='utf-8') as f:
            f.write('''# SHANTO HOSTING - Default Bot
import time

print("=" * 40)
print("Bot is running on SHANTO HOSTING")
...
def api_create_server():
    ...
    if not username:
        username = f"MAHMUDUL100K{random.randint(10000, 99999)}"
...
if __name__ == '__main__':
    print("\n" + "=" * 50)
    print("🚀 SHANTO HOSTING - FINAL")
    print("=" * 50)
    print("📍 Landing: http://shanto-web-hosting.onrender.com")
    print("📍 Admin: https://shanto-web-hosting.onrender.com/login")
    print("🔗 API: https://shanto-web-hosting.onrender.com/create")
    print("👤 ADMIN / SHANTO123")
    print("=" * 50 + "\n")
